...
<html lang="fr">
    <head>
        ...
        <title><?php echo e($structure->nom."_".$mois1."_".$annee1."_".$mois2."_".$annee2); ?></title>
    ...
    <body>
        ...
        <p style="font-size: 15px; text-align: center" class="text-center mt-5">
            <strong><u><?php echo e($structure->nom.", PERIODE DE ".$mois1." ".$annee1." A ".$mois2." ".$annee2); ?></u> </strong>
