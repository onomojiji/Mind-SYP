...
<div class="auth-page-wrapper pt-5">
    <!-- auth page bg -->
    <div class="auth-one-bg-position" id="auth-particles" style="background-image: url('{{asset("images/biometrie.jpg")}}')">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <p class="display-4 text-light fw-bold">{{__("Mayiwi")}}</p>
                        </div>
